...
import { getLoans, requestReturn, approveReturn, type BookLoan } from '../services/loanService';
                                ...
                                <div className="flex items-center gap-2">
                                    {isAdmin ? (
                                        ...
                                        loan.status === 'active' ? (
                                            ...
                                            <span className="text-xs text-gray-400 italic font-medium px-2">Processing...</span>
                                        )
                                    )}
                                </div>
                            </div>
